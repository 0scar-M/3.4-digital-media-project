...
public abstract partial class BaseBodyFile : Object
{
	...
	public BaseBodyFile(string Name, string TexturePath, float TextureRadius, Vector2 InitPosition, float Radius, float Mass)
	{
		this.Name = Name;
...
public partial class BodyFile : BaseBodyFile
{
	...
	public BodyFile(string Name, string TexturePath, float TextureRadius, Vector2 InitPosition, float Radius, float Mass, float OrbitRadius) : base(Name, TexturePath, TextureRadius, InitPosition, Radius, Mass)
	{
...
public partial class CentreBodyFile : BaseBodyFile
{
	...
	public CentreBodyFile(string Name, Vector2 InitPosition, float Radius, float Mass, string TexturePath, float TextureRadius) : base(Name, TexturePath, TextureRadius, InitPosition, Radius, Mass) {}
}
