...
public partial class LevelFile : Object
{
	...
	public LevelFile(int Num, string Goal, float GravityConst, CameraFile Camera, RocketFile Rocket, CentreBodyFile CentreBody, params BodyFile[] Bodies)
	{
		this.Num = Num;
		this.Goal = Goal;
...
public partial class RocketFile : Object
{
	...
	public float? MinFinalTime; // Amount of time these values need to be true for.
	...
	public float FatalCollisionSpeed = 50;
	
	public RocketFile(string InitBody, Vector2 InitPosition, float InitRotation, Vector2 InitVelocity, float Mass, float Scale, float ThrustImpulse, string FinalBody, float? MinFinalAltitude = null, float? MaxFinalAltitude = null, float? MinFinalSpeed = null, float? MaxFinalSpeed = null, float? MinFinalTime = null)
	
	{
		...
		this.MinFinalTime = MinFinalTime;
	}
}
